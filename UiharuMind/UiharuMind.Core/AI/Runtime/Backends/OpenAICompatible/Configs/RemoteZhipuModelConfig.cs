...
public class RemoteZhipuModelConfig : BaseRemoteModelConfig, IRemoteModelConfig
{
    ...
    public override IReadOnlyDictionary<string, RemoteModelIdVariant> ModelIdVariants { get; } =
        ...
        {
            ["glm-4-flash"] = new(ContextLength: 128000, MaxTokens: 8192),
            ["glm-4.7-flash"] = new(ContextLength: 128000, MaxTokens: 8192),
            ["glm-4"] = new(ContextLength: 128000, MaxTokens: 8192),
            ["glm-4-plus"] = new(ContextLength: 128000, MaxTokens: 8192),
            ["glm-4-air"] = new(ContextLength: 128000, MaxTokens: 8192),
            ["glm-4-airx"] = new(ContextLength: 128000, MaxTokens: 8192),
            ["glm-4-long"] = new(ContextLength: 1048576, MaxTokens: 8192),
            ["glm-4-flashx"] = new(ContextLength: 128000, MaxTokens: 8192),
            ["glm-4v-flash"] = new(ContextLength: 128000, MaxTokens: 8192, IsVision: true),
            ["glm-4.6v-flash"] = new(ContextLength: 128000, MaxTokens: 8192, IsVision: true),
            ["glm-4v-plus"] = new(ContextLength: 128000, MaxTokens: 8192, IsVision: true),
            ["glm-4v"] = new(ContextLength: 128000, MaxTokens: 8192, IsVision: true),
        };
