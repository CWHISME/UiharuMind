...
public class HarnessInstructionsCompositionTests
{
    ...
    public void AgentHarnessInstructions_StartWithFrameworkDefaults()
    {
        ...
        HarnessAgentOptions options = CharacterRunnerFactory.BuildAgentOptions(character, new AgentSettingConfig(),
...
public class ResearcherReadOnlyTests
{
    ...
    public void ResearcherTools_AreReadOnly()
    {
        ...
        HarnessAgentOptions? options = CharacterRunnerFactory.BuildResearcherOptions(new AgentSettingConfig(), workingDirectory);
    ...
    public void Researcher_NotMounted_WhenAllReadCapabilitiesDisabled()
    {
        ...
        Assert.Null(CharacterRunnerFactory.BuildResearcherOptions(config, Path.GetTempPath()));
    }
}
